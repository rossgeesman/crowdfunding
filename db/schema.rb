...
ActiveRecord::Schema.define(version: 20140831212640) do
  ...
  create_table "products", force: true do |t|
    ...
    t.integer  "price"
    t.string   "explainer_file_name"
    t.string   "explainer_content_type"
    t.integer  "explainer_file_size"
    t.datetime "explainer_updated_at"
  end
  ...
  add_index "products_traits", ["product_id", "trait_id"], name: "index_products_traits_on_product_id_and_trait_id", using: :btree
